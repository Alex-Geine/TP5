...
// TP5.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTP5App, CWinApp)
...
// Единственный объект CTP5App

CTP5App theApp;


// Инициализация CTP5App

BOOL CTP5App::InitInstance()
{
